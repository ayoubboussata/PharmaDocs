    ...
    <div>
      ...
      >
        ...
        {uploading ? (
          ...
          <>
            <span className="mb-3 flex h-11 w-11 items-center justify-center rounded-full bg-accent-soft text-accent-text">
              <UploadCloud size={22} />
            </span>
            <p className="text-sm font-medium text-fg">
              Sleep een factuur-PDF hierheen of <span className="text-accent-text">kies een bestand</span>
            </p>
            <p className="mt-1 text-xs text-subtle">PDF, max. 10 MB — de AI leest de gegevens automatisch uit</p>
          </>
        )}
      </div>
